...
class DashTodayLeadAdapter(var context: Activity, var list: ArrayList<MenuModelBean>, var rvClickListner: RvStatusClickListner) : RecyclerView.Adapter<DashTodayLeadAdapter.MyViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder { // infalte the item Layout
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_home_alltask, parent, false)
